const loaders=
{
	loadSound(src)
	{
		...
		ret.panNode=new PannerNode(globalsaudioContext,{coneInnerAngle:360,coneOuterAngle:360,maxDistance:32,positionX:0,positionY:0,positionZ:0,rolloffFactor:0});
